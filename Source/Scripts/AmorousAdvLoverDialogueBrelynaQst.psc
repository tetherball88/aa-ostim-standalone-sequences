...
Scriptname AmorousAdvLoverDialogueBrelynaQst Extends Quest Hidden
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE AmorousAdvLoverDialogueBrelynaQstUtil
Quest __temp = self as Quest
AmorousAdvLoverDialogueBrelynaQstUtil kmyQuest = __temp as AmorousAdvLoverDialogueBrelynaQstUtil
;END AUTOCAST
;BEGIN CODE
;--| STAGE 5: Initialize
actor akLover = Alias_aAmorousAdvAlias1.GetReference() as Actor
