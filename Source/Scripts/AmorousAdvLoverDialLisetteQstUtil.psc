Scriptname AmorousAdvLoverDialLisetteQstUtil extends Quest  

Function updateAmorousAdvLoverTimer()

	float DaysUntilNextAllowed = 4.50  ;three and half days expressed in GameDaysPassed
...
GlobalVariable Property AmorousAdvLoverTimer Auto  ;--|  AmorousAdvLisetteHungerTimer
