...
Scriptname AmorousAdvLoverDialLisetteQst Extends Quest Hidden
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE AmorousAdvLoverDialLisetteQstUtil
Quest __temp = self as Quest
AmorousAdvLoverDialLisetteQstUtil kmyQuest = __temp as AmorousAdvLoverDialLisetteQstUtil
;END AUTOCAST
;BEGIN CODE
;--| STAGE 5: Initialize
actor akLover = Alias_aAmorousAdvAlias1.GetReference() as Actor
