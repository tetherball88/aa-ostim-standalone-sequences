...
Scriptname AmorousAdvLoverDialAnnekkeQst Extends Quest Hidden
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE AmorousAdvLoverDialAnnekkeQstUtil
Quest __temp = self as Quest
AmorousAdvLoverDialAnnekkeQstUtil kmyQuest = __temp as AmorousAdvLoverDialAnnekkeQstUtil
;END AUTOCAST
;BEGIN CODE
;--| STAGE 5: Initialize
actor akLover = Alias_aAmorousAdvAlias1.GetReference() as Actor
