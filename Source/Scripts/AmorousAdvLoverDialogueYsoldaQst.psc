...
Scriptname AmorousAdvLoverDialogueYsoldaQst Extends Quest Hidden
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE AmorousAdvLoverDialogueYsoldaQstUtil
Quest __temp = self as Quest
AmorousAdvLoverDialogueYsoldaQstUtil kmyQuest = __temp as AmorousAdvLoverDialogueYsoldaQstUtil
;END AUTOCAST
;BEGIN CODE
;--| STAGE 5: Initialize
actor akLover = Alias_aAmorousAdvAlias1.GetReference() as Actor
