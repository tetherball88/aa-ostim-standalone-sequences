...
Scriptname AmorousAdvLoverDialCarlottaQst Extends Quest Hidden
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE AmorousAdvLoverDialCarlottaQstUtil
Quest __temp = self as Quest
AmorousAdvLoverDialCarlottaQstUtil kmyQuest = __temp as AmorousAdvLoverDialCarlottaQstUtil
;END AUTOCAST
;BEGIN CODE
;---| STAGE 5: Initialize
actor akLover = Alias_aAmorousAdvAlias1.GetReference() as Actor
