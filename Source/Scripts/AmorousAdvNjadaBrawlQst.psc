...
Scriptname AmorousAdvNjadaBrawlQst Extends Quest Hidden
...
;BEGIN AUTOCAST TYPE AmorousAdvNjadaBrawlQstUtil
Quest __temp = self as Quest
AmorousAdvNjadaBrawlQstUtil kmyQuest = __temp as AmorousAdvNjadaBrawlQstUtil
;END AUTOCAST
;BEGIN CODE
;forcegreet is done
...
kmyQuest.SexLabAmorousAdventuresNjada.SetStage(40)
SetStage(200)
;END CODE
EndFunction
;END FRAGMENT
