...
Scriptname AmorousAdvLoverDialogueLydiaQst Extends Quest Hidden
...
Function Fragment_7()
;BEGIN AUTOCAST TYPE AmorousAdvLoverDialogueLydiaQstUtil
Quest __temp = self as Quest
AmorousAdvLoverDialogueLydiaQstUtil kmyQuest = __temp as AmorousAdvLoverDialogueLydiaQstUtil
;END AUTOCAST
;BEGIN CODE
;--| STAGE 5: Initialize
...
;BEGIN CODE
;--| STAGE 30
;--| Follower Commentary Commented
kmyquest.LoverCommented()
SetStage(10)
;END CODE
EndFunction
;END FRAGMENT
